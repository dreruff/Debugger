...
public class FunctionEnvironmentRecord {
    ...
    public void setVarVal(String id, Integer literal) {
        ids.put(id, literal);
    }
    ...
    public static void main(String args[]) {
        ...
        fctEnvRecord.setVarVal("a", 4);         //Enter a 4
        fctEnvRecord.dump();                    //(<a/4>, g, 1, 20, 5))
        
        fctEnvRecord.setVarVal("b", 2);         //Enter b 2 
        fctEnvRecord.dump();                    //(<a/4,b/2>, g, 1, 20, 5)
        
        fctEnvRecord.setVarVal("c", 7);         //Enter c 7 
        fctEnvRecord.dump();                    //(<a/4,c/7,b/2>, g, 1, 20, 5)
        
        fctEnvRecord.setVarVal("a", 1);         //Enter a 1 
